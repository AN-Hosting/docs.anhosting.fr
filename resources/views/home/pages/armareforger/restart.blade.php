        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl font-bold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                    {{ __('Redémarrage Automatique') }}
                </h1>
                <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 dark:text-gray-400 sm:mt-4">
                    {{ __('Configurez les redémarrages automatiques de votre serveur pour une maintenance optimale') }}
                </p>
            </div>
        </div>
    </section>
...
<!--  Section -->
    <section class="mb-12">
        <div class="prose prose-lg dark:prose-invert max-w-none px-4 sm:px-6 lg:px-8">
            {!! Str::markdown(File::get(resource_path('markdown/armareforger/restart.md'))) !!}
        </div>
    </section>
@endsection